...
class Model {
    ...
    func configure() -> [Section]{
        models.append(Section(options: [
            .topCell(model: TopCellOption(icon: UIImage(named: "swift"),
                                          title: "Ян Жигурс",
                                          subtitleText: "Apple ID, iCloud, контент и покупки",
                                          handler: {
        ...
        models.append(Section(options: [
            ...
            .staticCell(model: SettingsOption(title: "Wi-Fi",
                                              icon: UIImage(systemName: "wifi"),
                                              iconBackgroundColor: .systemBlue,
                                              optionalText: "Не подключено",
                                              handler: {
            ...
            .staticCell(model: SettingsOption(title: "Cотовая связь",
            ...
            .staticCell(model: SettingsOption(title: "Режим модема",
        ...
        models.append(Section(options: [
            ...
            .staticCell(model: SettingsOption(title: "Звуки",
            ...
            .staticCell(model: SettingsOption(title: "Фокусирование",
            ...
            .staticCell(model: SettingsOption(title: "Экранное время",
        ...
        models.append(Section(options: [
            .badgeCell(model: SettingsBadgeOption(title: "Основные",
            ...
            .staticCell(model: SettingsOption(title: "Пункт управления",
            ...
            .staticCell(model: SettingsOption(title: "Экран и яркость",
            ...
            .staticCell(model: SettingsOption(title: "Экран домой",
            ...
            .staticCell(model: SettingsOption(title: "Универсальный доступ",
            ...
            .staticCell(model: SettingsOption(title: "Обои",
